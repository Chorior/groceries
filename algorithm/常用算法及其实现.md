...
C++ 标准容器包含 vector,deque,list,forward_list,array,string,map,set,multimap,multiset,unordered_map,unordered_set,unordered_multimap,unordered_multiset 14种类型。
