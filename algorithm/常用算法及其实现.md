...
int main()
{
	...
	/*arr1[0] = 1; arr1[1] = 2; arr1[2] = 3; arr1[3] = 2; arr1[4] = 4; arr1[5] = 1; arr1[6] = 2;
	arr2[0] = 2; arr2[1] = 4; arr2[2] = 3; arr2[3] = 1; arr2[4] = 2; arr2[5] = 1;*/
...
// LCS(i,j) = 
// (1) LCS(i - 1, j - 1) + 1             （Ai ＝ Bj）
// (2) max(LCS(i – 1, j), LCS(i, j – 1)) （Ai ≠ Bj）
void LCS::GenLcsMap()
{
	// 构造(m+1)*(n+1)二维数组
...
最长连续公共子序列--将映射表中每项定义为以Xi,Yj结尾的最长连续公共子序列的长度，那么转义方程如下：
